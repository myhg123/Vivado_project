...
set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { cin  }]; #IO_L2N_T0_34               ,Sch=SW9
...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { sum[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
...
set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { cout  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
