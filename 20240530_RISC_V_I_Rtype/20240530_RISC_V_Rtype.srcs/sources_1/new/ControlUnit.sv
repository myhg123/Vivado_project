...
module ControlUnit (
    ...
    always_comb begin :main_decoder
        case (op)
            ...
            `OP_TYPE_R : controls = 8'b1_0_0_0_xxx_0;  //R_type
            `OP_TYPE_IL: controls = 8'b1_1_1_0_000_0;  //ILtype
            `OP_TYPE_I : controls = 8'b1_1_0_0_000_0;  //I_type
            `OP_TYPE_S : controls = 8'b0_1_x_1_001_0;   //S_type
            `OP_TYPE_B : controls = 8'b0_0_x_0_010_1;   //B_type
            `OP_TYPE_U : controls = 8'b0_0_0_0_000_0;   //LUI_type
            `OP_TYPE_UA: controls = 8'b0_0_0_0_000_0;   //AUIPC_type
            `OP_TYPE_J : controls = 8'b0_0_0_0_000_0;   //J_type
            `OP_TYPE_JI: controls = 8'b0_0_0_0_000_0;   //JI_type
