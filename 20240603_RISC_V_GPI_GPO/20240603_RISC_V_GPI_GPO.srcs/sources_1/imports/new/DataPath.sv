...
module extend (
    ...
    always_comb begin
        case (extType)
            `EXT_TYPE_I: immext = {{21{instr[31]}}, instr[30:20]};
            `EXT_TYPE_IS: immext = {{27{instr[31]}}, instr[24:20]};
            `EXT_TYPE_S: immext = {{21{instr[31]}}, instr[30:25], instr[11:7]};
            `EXT_TYPE_B: immext = { {19{instr[31]}}, instr[7], instr[30:25], instr[11:8], 1'b0 };
            `EXT_TYPE_U: immext = {instr[31], instr[30:20], instr[19:12], 12'd0};
            `EXT_TYPE_J: immext = {{12{instr[31]}}, instr[19:12], instr[20], instr[30:25], instr[24:21], 1'b0};
