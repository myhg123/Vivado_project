...
HD_PWD='/home/yonn/vivado_project/20240520_UART/20240520_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_rx_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_rx_loop.tcl
