...
HD_PWD='/home/yonn/vivado_project/20240520_UART/20240520_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_rx_loop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tx_rx_loop.tcl -notrace
