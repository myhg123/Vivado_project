...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { inPortC[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { inPortC[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { inPortC[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { inPortC[3]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
set_property -dict { PACKAGE_PIN W15  IOSTANDARD LVCMOS33 } [get_ports { inPortD[0]  }]; #IO_L21N_T3_DQS_A06_D22_14  ,Sch=SW4
set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 } [get_ports { inPortD[1]  }]; #IO_L21P_T3_DQS_14          ,Sch=SW5
set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports { inPortD[2]  }]; #IO_L22N_T3_A04_D20_14      ,Sch=SW6
set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports { inPortD[3]  }]; #IO_L22P_T3_A05_D21_14      ,Sch=SW7
...
set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { OutPortB[0]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { OutPortB[1]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { OutPortB[2]  }]; #IO_25_14                     ,Sch=LED6
set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { OutPortB[3]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
# set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { OutPortC[0]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
# set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { OutPortC[1]  }]; #IO_L6P_T0_34                 ,Sch=LED9
# set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { OutPortC[2] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
# set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { OutPortC[3] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
# set_property -dict { PACKAGE_PIN P3   IOSTANDARD LVCMOS33 } [get_ports { OutPortD[0] }]; #IO_L12N_T1_MRCC_35           ,Sch=LED12
# set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports { OutPortD[1] }]; #IO_L12P_T1_MRCC_35           ,Sch=LED13
# set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { OutPortD[2] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
# set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { OutPortD[3] }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
...
#set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { Push_Button}]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
