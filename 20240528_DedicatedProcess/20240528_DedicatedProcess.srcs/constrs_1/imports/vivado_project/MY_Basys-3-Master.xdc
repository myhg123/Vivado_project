...
#set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { out[8]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
#set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { out[9]  }]; #IO_L6P_T0_34                 ,Sch=LED9
