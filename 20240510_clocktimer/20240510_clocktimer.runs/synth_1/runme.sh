...
HD_PWD='C:/Users/kccistc/Desktop/Verilog_Project/20240510_clocktimer/20240510_clocktimer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockTimer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockTimer.tcl
