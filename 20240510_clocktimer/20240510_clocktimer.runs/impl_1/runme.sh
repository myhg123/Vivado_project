...
HD_PWD='C:/Users/kccistc/Desktop/Verilog_Project/20240510_clocktimer/20240510_clocktimer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockTimer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockTimer.tcl -notrace
