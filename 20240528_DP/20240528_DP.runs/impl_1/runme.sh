...
HD_PWD='/home/yonn/vivado_project/20240528_DP/20240528_DP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DP.tcl -notrace
